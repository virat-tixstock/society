...
<?php $__env->startSection('content'); ?>
    <div class="row mt-4">
        <?php echo e(Form::model($maintenance, ['route' => ['maintenance.update', $maintenance->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data'])); ?>
        ...
        <div class="col-sm-12">
            ...
            <div class="card location">
                ...
                <div class="card-body">
                    <?php $__currentLoopData = $maintenance->Details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row location_list">
                            <div class="form-group col-lg-4 col-md-4">
                                <?php echo e(Form::label('', __('type'), ['class' => 'form-label'])); ?>

                                <?php echo Form::select('type[]', $type, $item->type, [
                            ...
                            <div class="form-group col-lg-3 col-md-3">
                                ...
                                <?php echo e(Form::number('amount[]', $item->amount, ['class' => 'form-control amount', 'placeholder' => __('Enter amount'), ])); ?>
                    ...
                    <?php if(count($maintenance->Details) == 0): ?>
                    <?php endif; ?>
                    <div class="row location_list">
                        <div class="form-group col-lg-4 col-md-4">
                            <?php echo e(Form::label('', __('type'), ['class' => 'form-label'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\society\resources\views/maintenance/edit.blade.php ENDPATH**/ ?>