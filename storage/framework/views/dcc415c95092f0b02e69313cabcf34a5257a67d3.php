                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="row align-items-center g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <p class="mb-0"><?php echo e(maintenancePrefix() . $maintenance->maintenance_id); ?></p>
                                    </div>
                                    <div class="col-sm-6 text-sm-end">
                                        <h6>
                                            <?php echo e(__('Month')); ?>

                                            <span class="text-muted f-w-400"><?php echo e(monthList()[$maintenance->month]); ?></span>
                                        </h6>
                                        <h6>
                                            <?php echo e(__('Status')); ?>

                                            <?php if($maintenance->status == 'Unpaid'): ?>
                                                <span class="badge text-bg-danger"><?php echo e($maintenance->status); ?></span>
                                            <?php else: ?>
                                                <span class="badge text-bg-success"><?php echo e($maintenance->status); ?></span>
                                            <?php endif; ?>
                            ...
                            <div class="col-sm-6">
                                <div class="border rounded p-3">
                                    ...
                                    <h5><?php echo e(!empty($maintenance->Member) ? $maintenance->Member->name : ''); ?></h5>
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            <?php
                                                $total = 0;
                                            ?>
                                            <?php $__currentLoopData = $maintenance->Details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $total += $detail->amount;
                                                ?>
                                                <tr>
                                                    <td><?php echo e(!empty($detail->MaintenanceType) ? $detail->MaintenanceType->title : '-'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\society\resources\views/maintenance/show.blade.php ENDPATH**/ ?>