(function () {
    ...
    var calendar = new FullCalendar.Calendar(document.getElementById('calendar'), {
        ...
        eventClick: function (info) {
            ...
            var e_date_end = clickedevent.extendedProps.ends === null ? '' : dateformat(clickedevent.extendedProps.ends);
            ...
            document.querySelector('.pc-event-time').innerHTML = e_date_end;
