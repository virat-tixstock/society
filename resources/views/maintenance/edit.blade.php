...
@section('content')
    <div class="row mt-4">
        {{ Form::model($maintenance, ['route' => ['maintenance.update', $maintenance->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
        ...
        <div class="col-sm-12">
            ...
            <div class="card location">
                ...
                <div class="card-body">
                    @foreach ($maintenance->Details as $item)
                        <div class="row location_list">
                            <div class="form-group col-lg-4 col-md-4">
                                {{ Form::label('', __('type'), ['class' => 'form-label']) }}
                                {!! Form::select('type[]', $type, $item->type, [
                                    'class' => 'form-control select2 type',
                                ]) !!}
                            </div>
                            <div class="form-group col-lg-3 col-md-3">
                                {{ Form::label('', __('amount'), ['class' => 'form-label']) }}
                                {{ Form::number('amount[]', $item->amount, ['class' => 'form-control amount', 'placeholder' => __('Enter amount'), ]) }}
                            </div>
                            <div class="form-group col-lg-4 col-md-4">
                    ...
                    @if (count($maintenance->Details) == 0)
                    @endif
                    <div class="row location_list">
                        <div class="form-group col-lg-4 col-md-4">
                            {{ Form::label('', __('type'), ['class' => 'form-label']) }}
